                    ...
                    <div className=' text-white mt-10 grid grid-cols-1 sm:grid-cols-2 text-center max-h-full w-full max-w-[1400px]'>
                        ...
                        <div className='grid gap-10 text-left pl-6 pr-3'>
                            <div className='flex flex-col group'>                    
                                <Image width={800} height={300} src={coding} alt={"coding"}className='rounded-xl border border-gray-600 opacity-60 group-hover:opacity-100 group-hover:border-gray-200 duration-700'></Image>
                            ...
                            <div className='flex flex-col group'>
                                <Image width={800} height={600} src={office}  alt={"office"} className='rounded-xl border border-gray-600 opacity-60 group-hover:opacity-100 group-hover:border-gray-200 duration-700'></Image>
                        ...
                        <div className='grid pr-6 pl-3 gap-10 text-left'>
                            <div className='flex flex-col mt-36 group '>
                                <Image width={800} height={300} src={charts} alt={"charts"} className='rounded-xl  border border-gray-600 opacity-60  group-hover:opacity-100 group-hover:border-gray-200 duration-700'></Image>
